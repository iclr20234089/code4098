...
from .torch.probabilistic_ensemble_dynamics_gru_impl import (
    ProbabilisticEnsembleDynamicsGruImpl,
)


class ProbabilisticEnsembleDynamicsGru(DynamicsBase):
    ...
    _impl: Optional[ProbabilisticEnsembleDynamicsGruImpl]
    ...
    def __init__(
        ...
        *,
        ...
        impl: Optional[ProbabilisticEnsembleDynamicsGruImpl] = None,
        **kwargs: Any
    ):
        super().__init__(
    ...
    def _create_impl(
        ...
        self._impl = ProbabilisticEnsembleDynamicsGruImpl(
