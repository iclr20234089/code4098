...
from .base import DoneBase
from .torch.done_impl import (
    DoneImpl,
)
...
class Done(DoneBase):
    ...
    def _update(self, batch: TransitionMiniBatch,n_step) -> Dict[str, float]:
